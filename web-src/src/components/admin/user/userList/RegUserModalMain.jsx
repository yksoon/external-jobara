                    ...
                    <tr>
                        ...
                        <td>
                            <select
                                ...
                                ref={selectUserRole}
                                defaultValue={
                                    modUserData && modUserData.user_role_cd
                                }
                            >
                    ...
                    <tr>
                        ...
                        <td>
                            <select
                                ...
                                defaultValue={
                                    modUserData && modUserData.user_status_cd
                                }
                            >
                        ...
                        <td>
                            {modUserData ? (
                                <input
                                    ...
                                    ref={inputID}
                                    defaultValue={
                                        modUserData ? modUserData.user_id : ""
                                    }
                                    readOnly
                                />
                            ) : (
                        ...
                        <td>
                            <div id="phone_num" className="m0">
                                ...
                                <input
                                    ...
                                    id="phone_num2"
                                    defaultValue={
                                        modUserData ? modUserData.mobile2 : ""
                                    }
                                    ref={inputMobile2}
                                />
                                <input
                                    ...
                                    id="phone_num3"
                                    defaultValue={
                                        modUserData ? modUserData.mobile3 : ""
                                    }
                                    ref={inputMobile3}
                                />
                            </div>
